...
def load(app):
    ...
    try:
        ...
        try:
            ...
            warnings.warn(f"Initialization Failed: {str(e)}", WhaleWarning)
            return
        ...
        try:
            ...
            print("[CTFd Whale] Another instance is already running")
        except Exception as e:
            print(f"[CTFd Whale] Failed to start scheduler: {str(e)}")
    except Exception as e:
        print(f"[CTFd Whale] Failed to initialize: {str(e)}")
        raise